...
window.openSosMode      = openSosMode;
window.closeSosMode     = closeSosMode;
window._spNav           = _spNav;
window._spGoTo          = _spGoTo;
window._spSaveProgress  = _spSaveProgress;
window._spFinalSave     = _spFinalSave;
window._spGetSuggestions= _spGetSuggestions;
window._spInsertSuggestion = _spInsertSuggestion;
window._spPrint         = _spPrint;
window._spAutoSave      = _spAutoSave;
window.trackCopingStrategy = trackCopingStrategy;
